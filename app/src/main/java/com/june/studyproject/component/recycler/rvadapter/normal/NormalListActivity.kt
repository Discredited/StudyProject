...
class NormalListActivity : BaseActivity() {
    ...
    override fun getLayoutResId(): Int = R.layout.activity_normal_list

    override fun initView() {
        rvNormalMulti.setLinearManager()
        rvNormalMulti.adapter = mAdapter
        rvNormalMulti.setHasFixedSize(true)
        rvNormalMulti.addLinearItemDecoration()
    }

    override fun loadData() {
        mAdapter.setNewList(mutableListOf(
